...
export const DUMMY_TWEETS = [
  {
    id: "tweet-1",
    username: "@marketguru",
    text: "Bullish on Reliance! Strong fundamentals and Jio's growth trajectory looks promising. #RELIANCE #StockMarket",
  ...
  },
  {
    id: "tweet-2",
    username: "@traderpro",
    text: "TCS AI partnership could be a game changer. Long-term hold for sure! #TCS #AI #Investing",
  ...
  },
  {
    ...
    text: "HDFC Bank's digital push is exactly what banking needs. Innovation at its best! #HDFCBANK #DigitalBanking",
  ...
  },
  {
    ...
    text: "Cautious on IT sector short-term due to global headwinds, but Infosys fundamentals remain strong. #INFY #Markets",
